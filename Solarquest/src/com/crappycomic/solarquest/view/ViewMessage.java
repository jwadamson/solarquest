...
public class ViewMessage implements Serializable
{
   ...
   public static enum Type
   {
      ...
      MODEL_PRE_LAND,
      MODEL_POST_ROLL,
      MODEL_CHOOSING_PROPERTY_LOST_TO_LEAGUE,
      MODEL_CHOOSING_PROPERTY_WON_FROM_LEAGUE,
      MODEL_CHOOSING_PROPERTY_WON_FROM_PLAYER,
      MODEL_GAME_OVER,
      MODEL_INVALID_STATE,
      ...
      PLAYER_HAD_NO_PROPERTY_TO_LOSE,
      PLAYER_HAD_NO_PROPERTY_TO_WIN,
